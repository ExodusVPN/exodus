...
/// ](http://www.cs.northwestern.
/// edu/~agupta/cs340/project2/TCPIP_State_Transition_Diagram.pdf)
///
/// A connection progresses through a series of states during its lifetime. The
/// states are: LISTEN, SYN-SENT, SYN-
/// RECEIVED, ESTABLISHED, FIN-WAIT-1, FIN-WAIT-2, CLOSE-WAIT, CLOSING,
/// LAST-ACK, TIME-WAIT, and
/// the  fictional state CLOSED. CLOSED is fictional because it represents the
/// state when there is no TCB, and therefore, no connection.
///
/// A TCP connection progresses from one state to another in response to
/// events. The events are the user calls,
/// OPEN, SEND, RECEIVE, CLOSE, ABORT, and STATUS; the incoming segments,
...
/// https://en.wikipedia.
/// org/wiki/Transmission_Control_Protocol#TCP_segment_structure
#[derive(Debug, PartialEq, Eq)]
