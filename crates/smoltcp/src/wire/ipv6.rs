...
impl Address {
    ...
    pub fn as_ipv4(&self) -> Option<crate::wire::ipv4::Address> {
        if self.is_ipv4_mapped() {
            Some(crate::wire::ipv4::Address::new(self.0[12], self.0[13], self.0[14], self.0[15]))
        } else {
            None
        }
    }
...
impl From<crate::wire::ipv4::Address> for Address {
    fn from(address: crate::wire::ipv4::Address) -> Self {
